...
public class ViewBook extends javax.swing.JFrame {
    ...
    ViewBookDAO viewBooks;
    public ViewBook() {
        this.tableModel = new DefaultTableModel(new Object[]{"ID","Book Name","Genre","Price"},0);
        this.tableModel = new DefaultTableModel(new Object[]{"ID","Book Name","Genre","Price"},1);
        setTitle("Books Available");
        initComponents();
        viewBooks = new ViewBookDAO();
        ArrayList<Book> books = new ArrayList();
        books = viewBooks.getAllBooks();
        for(Book book :books){
